        ...
        return (
            <View style={{ flexDirection: 'row', alignItems: 'center', minHeight: 80, borderBottomColor: 'rgba(0,0,0,0.5)', borderBottomWidth: 0.5, marginHorizontal: 6 }}>
                <View style={{ flex: 8, justifyContent: 'center' }}>
                    {
                        item.author &&
                        <Text style={{ color: 'black', fontSize: 18, fontWeight: 'bold' }}>{item.author}</Text>
                    }
                    {
                        item.comment &&
            ...
            <View style={{ flex: 1, backgroundColor: 'white' }}>
                ...
                <View style={{ flexDirection: 'row', margin: 6 }}>
                    ...
                    <View style={{ flex: 5 }}>
                        ...
                        <Text style={{ color: 'black', fontSize: 16, marginBottom: 18 }}> <Icon name='clock-o' size={18} color={primary} /> {evento.schedule} </Text>
